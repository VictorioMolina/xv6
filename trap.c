...
trap(struct trapframe *tf)
{
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    ...
    lapiceoi();
    break;
  case T_PGFLT: // We are catching this exception here to make the code more legible
    {
      // Lazy allocation for page faults
      // rcr2() -> dir. page fault
      ...
      if(va >= myproc()->sz)
        panic("lazy page allocation: out of boundaries");
      ...
      else 
      {
        ...
        {
          cprintf("kalloc out of memory (2)\n");
          kfree(mem);
        };
      }
    }
